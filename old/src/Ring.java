...
public class Ring {
    ...
    public void addNode(MyNode node) {
        ...
        Collections.sort(listNodes, new Comparator<MyNode>() {
            // On trie la liste par ordre d'ID de noeud croissant
            @Override
        ...
        this.setNeighbors();
        System.out.println("node " + node.getID()+ " added");
    ...
    public void removeNode(MyNode node) {
        ...
        this.setNeighbors();
        System.out.println("Node " + node.getID()+ " removed");
    }
    ...
    public MyNode getRandomNode(){
        //return a random node of the Ring
        int i = new Random().nextInt(this.listNodes.size());
